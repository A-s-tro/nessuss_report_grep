...
nessus_file_path = r"Veem Rreplication Server_s9tx5l.nessus" # ex- C:/download/1.HF-SRV-01/HF-SRV-01.nessus
...
for report_item in root.findall(".//ReportItem"):
    ...
    if severity in severity_levels:
        vuln_data = {
            ...
            "Recommendation": report_item.findtext("solution", "N/A"),
            "Evidence": report_item.findtext("plugin_output", "N/A")
        }
...
for severity, vulns in vulnerabilities.items():
    if vulns:
        ...
        for vuln in vulns:
            ...
            headings = ["Criticality", "Synopsis", "Description", "Recommendation", "Evidence"]
...
output_file_path = r"25.docx" # this file has be in .docx format ex- C:/download/1.HF-SRV-01/nessusreport.docx
